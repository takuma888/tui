...
var Popout = function ($) {
  ...
  function () {
    ...
    _proto._getPlacement = function _getPlacement() {
      var $parentPopout = $(this._element).parent();
  ...
  $(document).on(Event.KEYDOWN_DATA_API, Selector.DATA_TOGGLE, Popout._dataApiKeydownHandler).on(Event.KEYDOWN_DATA_API, Selector.MENU, Popout._dataApiKeydownHandler).on(Event.CLICK_DATA_API + " " + Event.KEYUP_DATA_API, Popout._clearMenus).on(Event.CLICK_DATA_API, Selector.DATA_TOGGLE, function (event) {
    event.preventDefault();
    event.stopPropagation();
